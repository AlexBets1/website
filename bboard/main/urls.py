...
from.views import profile, BBLogoutView, BBLoginView, index, other_page, ChangeUserInfoView, BBPasswordChangeView, \
RegisterUserView, RegisterDoneView, user_activate, DeleteUserView,  BBPasswordResetView, \
BBPasswordResetDoneView, BBPasswordResetConfirmView, BBPasswordResetCompleteView, by_rubric, detail,  \
